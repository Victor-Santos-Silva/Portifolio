  ...
  return (
    <>
      <section className="container-saint-michel">
        ...
        <h2>Descrição:</h2>
        <p>
          Criado para um ambiente hospitalar, esse sistema resolve um dos
          maiores desafios da área da saúde: agendamentos confusos e demorados.
          Com ele, pacientes agendam consultas de forma prática e intuitiva,
          enquanto a equipe médica ganha mais controle e organização.
        </p>
        <Link
          to="https://hospitalsaintmichel.vercel.app/"
          target="_blank"
